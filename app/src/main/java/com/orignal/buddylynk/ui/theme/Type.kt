...
// =============================================================================
// BUDDYLYNK TYPOGRAPHY
// Modern, Clean, Premium Feel
// =============================================================================

// Custom Font Family - Using system default for now, can be replaced with Google Fonts
val BuddyLynkFontFamily = FontFamily.Default

// Premium Typography Scale
val Typography = Typography(
    // Display styles - Hero text, splash screens
    displayLarge = TextStyle(
        fontFamily = BuddyLynkFontFamily,
